...
(defun opam-setup-merlin ()
  ...
  (set-face-background 'merlin-type-face "gray25"))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## a3f189963b22027408c99b7e9ee29b2d ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/benno/.opam/dai/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/benno/.opam/dai/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/benno/.opam/dai/bin/ocp-indent"))
